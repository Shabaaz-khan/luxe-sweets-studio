    ...
    Starting From
      ...
      <div className="p-5 [transform:translateZ(20px)]">
        ...
        <button
          ...
          className="mt-5 w-full inline-flex items-center justify-center gap-2 rounded-full border border-[rgb(126,0,62)] bg-[rgb(126,0,62)] py-2.5 text-sm text-white hover:bg-white hover:text-[rgb(126,0,62)] hover:border-[rgb(126,0,62)] transition-all duration-300">
          Add to order
        </button>
      </div>
    </motion.article>
